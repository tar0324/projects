...
<%
	...
	count = bdao.getSearchCount(searchword);
	...
	//게시글 리턴
	Vector<BboardBean> vec = bdao.getsearchsub(searchword); 
...
<nav aria-label="Page navigation example" >
  <ul class="pagination justify-content-center" >
    ...
    %>
    <li class="page-item"><a class="page-link" href="RencarMain.jsp?center=CarQNA.jsp?pageNum=<%=i %> "><%=i %></a>
    </li>
    <%
    	}
